...
creature to get to the exit and mark the path explored. This does not find
the shortest path to the exit, just a possible exit. Will demonstrate use of recursion
to go through methods that move creature throughout maze until exit is found.
